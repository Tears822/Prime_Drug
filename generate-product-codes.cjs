...
const products = [
  ...
  // Peptides
  { name: "GHK-Cu", category: "Peptide", codesPerProduct: 50 },
  ...
  { name: "MT-2 (Melanotan II)", category: "Peptide", codesPerProduct: 50 },
  { name: "Selank", category: "Peptide", codesPerProduct: 50 },
  { name: "CJC-1295 DAC", category: "Peptide", codesPerProduct: 50 },
